...
`;
  ...
  getErrorDailyAnalysis() {
    return {
      overall_score: 50,
      performance_summary: "今日の学習お疲れさまでした。分析システムに一時的な問題が発生していますが、学習記録は保存されています。",
      thinking_patterns: ["学習記録が継続されています"],
      strength_areas: ["継続的な学習"],
      weakness_areas: ["分析機能の一時的な問題"],
      mistake_analysis: "現在分析できませんが、学習データは記録されています。",
      improvement_suggestions: ["学習の継続"],
      tomorrow_focus: "今日と同様のペースで学習を継続",
      study_efficiency: "記録された学習データは後日分析可能です。",
      motivational_message: "継続的な学習が最も重要です。明日も頑張りましょう！"
    };
  }
